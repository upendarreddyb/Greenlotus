(function ($) {
  ...
  // Date Picker
  if ($(".greenlotus-datepicker").length) {
    $(".greenlotus-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accrodion
  if ($(".greenlotus-accrodion").length) {
    var accrodionGrp = $(".greenlotus-accrodion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".greenlotus-accrodion." + accrodionName)
                .find(".accrodion")
                .removeClass("active");
              $(".greenlotus-accrodion." + accrodionName)
                .find(".accrodion")
  ...
  function thmOwlInit() {
    // owl slider
    let greenlotusowlCarousel = $(".greenlotus-owl__carousel");
    if (greenlotusowlCarousel.length) {
      greenlotusowlCarousel.each(function () {
        let elm = $(this);
    ...
    let greenlotusowlCarouselNav = $(".greenlotus-owl__carousel--custom-nav");
    if (greenlotusowlCarouselNav.length) {
      greenlotusowlCarouselNav.each(function () {
        let elm = $(this);
  ...
  function thmTinyInit() {
    // tiny slider
    const tinyElm = document.querySelectorAll(".greenlotus-tiny__slider");
  ...
  //Strech Column
  function greenlotus_stretch() {
    var i = $(window).width();
    $(".row .greenlotus-stretch-element-inside-column").each(function () {
      var $this = $(this),
  ...
  function greenlotus_cuved_circle() {
